...
<body>
	...
	<h1 style="color: grey; font-size: 40px;" align="center">Bhumesh is the best coder in devops</h1>
	<h1 style="color: blue; font-size: 40px;" align="center">the next ceo of devops/cd</h1>
	<h1 style="color: black; font-size: 40px;" align="center">we are done with nexus also</h1>
	<h1 style="color: black; font-size: 40px;" align="center">we are done with nexus also</h1>
	<h1 style="color: orange; font-size: 40px;" align="center">jenkins in ci/cd tool</h1>
